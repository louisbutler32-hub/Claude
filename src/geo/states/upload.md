# What if Every US State Went to War?

## Title

What if All 50 States Went to War? 🇺🇸⚔️

Alternates:

- 50 States at War: Who Wins? 🤔🗺️
- The 3 States That Would Win a War Between All 50 ☢️ #shorts
...
what if states went to war, us states at war, 50 states, who would win, california, texas, virginia, wyoming, montana, north dakota, nuclear missiles, minuteman, alternate history, thought experiment, maps, geography, geo shorts, map facts, learning, united states, usa facts

## Thumbnail

`out/thumbnail-geo-states.jpg`, 1080×1920 — built with `npm run geo:states:thumb`.
...
| Music | "Accralate" by Kevin MacLeod, CC BY 4.0 — the credit block above must stay in the description. The bed is a local drop-in at `public/audio/geo-states-music.mp3` (cut with `python3 scripts/make-geo-music.py states <track.mp3>`), not in the repo. Render with `npm run geo:states:music`. |
